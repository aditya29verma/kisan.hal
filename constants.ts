const createOptions = (arr: string[]) => arr.map(item => ({ value: item, label: item }));

export const soilTypes = createOptions([
    "Alluvial Soil", "Black Cotton Soil", "Red and Yellow Soil", "Laterite Soil", "Mountainous or Forest Soil", "Arid or Desert Soil", "Saline and Alkaline Soil", "Peaty and Marshy Soil", "Sandy Soil", "Silt Soil", "Clay Soil", "Loamy Soil"
]);

export const cropTypes = createOptions([
    "Wheat", "Rice", "Maize", "Barley", "Sorghum (Jowar)", "Bajra (Pearl Millet)", "Gram (Chana)", "Arhar (Tur/Red Gram)", "Moong (Green Gram)", "Groundnut", "Soybean", "Mustard", "Sunflower", "Cotton", "Sugarcane", "Mango", "Banana", "Apple", "Grapes", "Orange", "Spices"
]);

export const seedTypes = createOptions([
    "Nucleus Seed", "Breeder Seed", "Foundation Seed", "Registered Seed", "Certified Seed"
]);

export const seedNames = createOptions([
    "Rice", "Wheat", "Millets", "Pulses", "Oilseeds", "Maize", "Urd", "Niger", "Soybean", "Arhar", "Mustard", "Groundnut", "Til", "Masoor", "Pea", "Moong", "Jwar", "Sunflower", "Chilli", "Ginger", "Garlic", "Turmeric", "Coriander"
]);

export const growthStages = createOptions([
    "Germination", "Vegetative Growth", "Reproductive Stage", "Flowering", "Fruit Development", "Maturation", "Harvesting"
]);

export const optimizationGoals = createOptions([
    "Increase Yield",
...
export const currentYields = createOptions([
    "Below Average",
    "Average for the region",
    "Above Average",
]);

export const irrigationMethods = createOptions([
    "Drip Irrigation",
    "Sprinkler System",
...
export const fertilizerPrograms = createOptions([
    "Primarily Organic (Manure, Compost)",
    "Balanced Chemical (NPK)",
    "Integrated Nutrient Management (Both)",
    "None",
]);

export const stateDistrictMap: { [key: string]: string[] } = {
    ...
    "Chhattisgarh": ["Balod", "Baloda Bazar", "Balrampur", "Bastar", "Bemetara", "Bijapur", "Bilaspur", "Dantewada (South Bastar)", "Dhamtari", "Durg", "Gariaband", "Janjgir-Champa", "Jashpur", "Kabirdham (Kawardha)", "Kanker (North Bastar)", "Kondagaon", "Korba", "Koriya (Korea)", "Mahasamund", "Mungeli", "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sukma", "Surajpur", "Surguja"],
    ...
    "Uttar Pradesh": ["Agra", "Aligarh", "Allahabad", "Ambedkar Nagar", "Amethi (Chatrapati Sahuji Mahraj Nagar)", "Amroha (J.P. Nagar)", "Auraiya", "Azamgarh", "Baghpat", "Bahraich", "Ballia", "Balrampur", "Banda", "Barabanki", "Bareilly", "Basti", "Bhadohi", "Bijnor", "Budaun", "Bulandshahr", "Chandauli", "Chitrakoot", "Deoria", "Etah", "Etawah", "Faizabad", "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddha Nagar", "Ghaziabad", "Ghazipur", "Gonda", "Gorakhpur", "Hamirpur", "Hapur (Panchsheel Nagar)", "Hardoi", "Hathras (Mahamaya Nagar)", "Jalaun", "Jaunpur", "Jhansi", "Kannauj", "Kanpur Dehat", "Kanpur Nagar", "Kasganj (Kanshiram Nagar)", "Kaushambi", "Kushinagar (Padrauna)", "Lakhimpur - Kheri", "Lalitpur", "Lucknow", "Maharajganj", "Mahoba", "Mainpuri", "Mathura", "Mau", "Meerut", "Mirzapur", "Moradabad", "Muzaffarnagar", "Pilibhit", "Pratapgarh", "RaeBareli", "Rampur", "Saharanpur", "Sambhal (Bheem Nagar)", "Sant Kabir Nagar", "Sant Ravidas Nagar", "Shahjahanpur", "Shamali (Prabuddh Nagar)", "Shravasti", "Siddharth Nagar", "Sitapur", "Sonbhadra", "Sultanpur", "Unnao", "Varanasi"],
    "Uttarakhand": ["Almora", "Bageshwar", "Chamoli", "Champawat", "Dehradun", "Haridwar", "Nainital", "Pauri Garhwal", "Pithoragrah", "Rudraprayag", "Tehri Garhwal", "Udham Singh Nagar", "Uttarkashi"],
...
export const districtCityMap: { [key: string]: string[] } = {
    // Chhattisgarh
    "Durg": ["Bhilai", "Durg", "Bhilai Charoda", "Jamul", "Ahiwara", "Kumhari", "Patan", "Dhamdha", "Utai"],
    "Raipur": ["Raipur", "Tilda Newra", "Gobranawapara", "Arang", "Abhanpur"],
    "Bilaspur": ["Bilaspur", "Kota", "Takhatpur", "Ratanpur"],
    // Uttar Pradesh
    "Agra": ["Agra", "Fatehpur Sikri", "Bah", "Achhnera", "Tundla"],
    "Lucknow": ["Lucknow", "Malihabad", "Gosainganj", "Kakori"],
    "Varanasi": ["Varanasi", "Ramnagar", "Mughalsarai", "Pindra"],
    // Default/fallback
    "Default": ["City 1", "City 2", "City 3"],
};


export const states = createOptions(Object.keys(stateDistrictMap).sort());
